...
.then(() => client.query("CREATE TABLE users (firstname character varying(50),lastname character varying(50),email character varying(50),position character varying(50), show character varying(2))"))
...
.then(() => client.query("INSERT INTO users values ('Shabbi','Kesa','kesash@mail.uc.edu','A', 'S')"))
.then(() => client.query("INSERT INTO users values ('Shabbi1','Kesa','kesash@mail.uc.edu','A', 'S')"))
